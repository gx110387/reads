...
- (void)defaultSetUp
{
    ...
    if (!self.contentView) {
        ...
        if ([self.delegate respondsToSelector:@selector(viewPagerDidAddContentView)]) {
            ...
            [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-44-[contentView]-0-|" options:0 metrics:nil views:views]];
        }
    }
