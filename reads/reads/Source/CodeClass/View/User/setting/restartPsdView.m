...
-(void)p_setupView
{
    ...
    self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 50, 80, 40)];
    ...
    self.makeSubmit.frame = CGRectMake(CGRectGetMinX(self.passaginTextField.frame), CGRectGetMaxY(self.passaginTextField.frame)+20, 100, 40);
    
    [self.makeSubmit setTitle:@"确认修改" forState:UIControlStateNormal];
    [self addSubview:_makeSubmit];
    self.makeSubmit.backgroundColor = gbgcontentcolor;
    self.makeSubmit.tintColor = [UIColor colorWithRed:0/255.0 green:175/255.0 blue:240/255.0 alpha:1];
    self.makeSubmit.layer.cornerRadius = 10;
