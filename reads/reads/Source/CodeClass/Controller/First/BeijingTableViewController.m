...
@interface BeijingTableViewController ()<SDCycleScrollViewDelegate,MWPhotoBrowserDelegate>
...
@implementation BeijingTableViewController
...
{    [tools G_getBeiInfoData:0 forword:20 passValue:^(NSMutableArray *array) {
...
{
    [tools G_getBeiInfoData:self.g_dataArr.count forword:20 passValue:^(NSMutableArray *array) {
