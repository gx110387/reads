...
@interface TiYuTableViewController ()<SDCycleScrollViewDelegate,MWPhotoBrowserDelegate>
...
@implementation TiYuTableViewController
...
{    [tools G_getTiyuInfoData:0 forword:40 passValue:^(NSMutableArray *array) {
...
{
    [tools G_getTiyuInfoData:self.g_dataArr.count  forword:20 passValue:^(NSMutableArray *array) {
