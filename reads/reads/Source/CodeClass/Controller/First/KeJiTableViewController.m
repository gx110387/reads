...
@interface KeJiTableViewController ()<SDCycleScrollViewDelegate,MWPhotoBrowserDelegate>
...
@implementation KeJiTableViewController
...
{    [tools G_getKejiInfoData:0 forword:40 passValue:^(NSMutableArray *array) {
...
{
    [tools G_getKejiInfoData:self.g_dataArr.count forword:20 passValue:^(NSMutableArray *array) {
