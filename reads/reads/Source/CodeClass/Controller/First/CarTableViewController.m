...
@interface CarTableViewController ()<SDCycleScrollViewDelegate,MWPhotoBrowserDelegate>
...
{    [tools G_getCarInfoData:0 forword:40 passValue:^(NSMutableArray *array) {
...
{
    [tools G_getCarInfoData:self.g_dataArr.count  forword:20 passValue:^(NSMutableArray *array) {
