...
@interface EduTableViewController ()<SDCycleScrollViewDelegate,MWPhotoBrowserDelegate>
...
@implementation EduTableViewController
...
{    [tools G_getEduInfoData:0 forword:40 passValue:^(NSMutableArray *array) {
...
- (void)footerRereshing
{
    ...
    [tools G_getEduInfoData:self.g_dataArr.count forword:20 passValue:^(NSMutableArray *array) {
