...
@interface LvyouTableViewController ()<SDCycleScrollViewDelegate,MWPhotoBrowserDelegate>
...
@implementation LvyouTableViewController
...
{    [tools G_getTripsInfoData:0 forword:40 passValue:^(NSMutableArray *array) {
...
- (void)footerRereshing
{
    ...
    [tools G_getTripsInfoData:self.g_dataArr.count forword:20 passValue:^(NSMutableArray *array) {
