//
//  PlayActivityTableViewController.m
//  reads
//
...
@interface PlayActivityTableViewController ()<SDCycleScrollViewDelegate,MWPhotoBrowserDelegate>
...
@implementation PlayActivityTableViewController
...
{    [tools G_getPlayInfoData:0 forword:40 passValue:^(NSMutableArray *array) {
...
{
    [tools G_getPlayInfoData:self.g_dataArr.count forword:20 passValue:^(NSMutableArray *array) {
