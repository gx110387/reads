...
@interface CaiJingTableViewController ()<SDCycleScrollViewDelegate,MWPhotoBrowserDelegate>
...
@implementation CaiJingTableViewController
...
{    [tools G_getCaijingInfoData:0 forword:40 passValue:^(NSMutableArray *array) {
...
{
    [tools G_getCaijingInfoData:self.g_dataArr.count  forword:20 passValue:^(NSMutableArray *array) {
